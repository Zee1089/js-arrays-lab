...
// assign the pizza element based on it s index to a variable called favFood
...
const odds = nums.slice(1, 8) + ',' + nums.slice(9, 11);
...
// I helped myself from that website
//https://www.freecodecamp.org/news/javascript-2d-arrays/

let total = 0;
//using let as the total is going to be changed (so can't be using const)
